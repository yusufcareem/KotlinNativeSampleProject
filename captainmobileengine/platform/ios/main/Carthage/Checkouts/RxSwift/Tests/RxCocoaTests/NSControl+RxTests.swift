...
extension NSControlTests {
    ...
    func test_controlEvent() {
        ...
        if let target = control.target, let com.careem.adma.booking.framework.action = control.com.careem.adma.booking.framework.action {
            _ = target.perform(com.careem.adma.booking.framework.action, with: target)
        }
