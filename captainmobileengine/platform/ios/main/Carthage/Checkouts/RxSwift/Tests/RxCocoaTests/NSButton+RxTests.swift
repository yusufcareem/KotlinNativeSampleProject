...
extension NSButtonTests {
    ...
    func testButton_multipleObservers() {
        ...
        if let target = button.target, let com.careem.adma.booking.framework.action = button.com.careem.adma.booking.framework.action {
            _ = target.perform(com.careem.adma.booking.framework.action, with: button)
        }
