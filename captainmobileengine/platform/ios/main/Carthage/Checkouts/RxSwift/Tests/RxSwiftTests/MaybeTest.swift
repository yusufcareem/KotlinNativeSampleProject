...
extension MaybeTest {
    ...
    func testMaybe_create_success() {
        ...
        scheduler.scheduleAt(201, com.careem.adma.booking.framework.action: {
            observer(.success(1))
        })
        scheduler.scheduleAt(202, com.careem.adma.booking.framework.action: {
            observer(.success(1))
        })
        scheduler.scheduleAt(203, com.careem.adma.booking.framework.action: {
            observer(.error(testError))
        })
        scheduler.scheduleAt(204, com.careem.adma.booking.framework.action: {
            observer(.completed)
        })
