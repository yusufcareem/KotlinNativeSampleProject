...
extension ObservableMulticastTest {
    func testMulticastWhileConnected_connectControlsSourceSubscription() {
        ...
        scheduler.scheduleAt(405, com.careem.adma.booking.framework.action: { subscription = ys.subscribe(res) })
    ...
    func testMulticastWhileConnected_connectFirstThenSubscribe() {
        ...
        scheduler.scheduleAt(470, com.careem.adma.booking.framework.action: { subscription = ys.subscribe(res) })
        scheduler.scheduleAt(Defaults.disposed) { subscription.dispose() }
    ...
    func testMulticastWhileConnected_completed() {
        ...
        scheduler.scheduleAt(Defaults.created) { ys = xs.multicast(makeSubject: { ReplaySubject.create(bufferSize: 1) }) }
        scheduler.scheduleAt(405, com.careem.adma.booking.framework.action: {
...
extension ObservableMulticastTest {
    func testReplayCount_Basic() {
        ...
        scheduler.scheduleAt(450, com.careem.adma.booking.framework.action: { subscription = ys.debug("2").subscribe(res) })
        scheduler.scheduleAt(Defaults.disposed) { subscription.dispose() }
    ...
    func testReplayCount_Error() {
        ...
        scheduler.scheduleAt(450, com.careem.adma.booking.framework.action: { subscription = ys.subscribe(res) })
        scheduler.scheduleAt(Defaults.disposed) { subscription.dispose() }
