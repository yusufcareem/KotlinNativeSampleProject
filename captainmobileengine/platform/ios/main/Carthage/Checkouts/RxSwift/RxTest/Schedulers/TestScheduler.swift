...
public class TestScheduler : VirtualTimeScheduler<TestSchedulerVirtualTimeConverter> {
    ...
    */
    ...
    /**
     Schedules an com.careem.adma.booking.framework.action to be executed at the specified virtual time.

     - parameter time: Absolute virtual time at which to execute the com.careem.adma.booking.framework.action.
     */
    public func scheduleAt(_ time: TestTime, com.careem.adma.booking.framework.action: @escaping () -> Void) {
        _ = self.scheduleAbsoluteVirtual((), time: time, com.careem.adma.booking.framework.action: { _ -> Disposable in
