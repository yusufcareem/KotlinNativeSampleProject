...
public class SerialDispatchQueueScheduler : SchedulerType {
    ...
    */
    public final func schedule<StateType>(_ state: StateType, com.careem.adma.booking.framework.action: @escaping (StateType) -> Disposable) -> Disposable {
        return self.scheduleInternal(state, com.careem.adma.booking.framework.action: com.careem.adma.booking.framework.action)
    }

    func scheduleInternal<StateType>(_ state: StateType, com.careem.adma.booking.framework.action: @escaping (StateType) -> Disposable) -> Disposable {
        return self.configuration.schedule(state, com.careem.adma.booking.framework.action: com.careem.adma.booking.framework.action)
    }
    ...
    */
    public final func scheduleRelative<StateType>(_ state: StateType, dueTime: Foundation.TimeInterval, com.careem.adma.booking.framework.action: @escaping (StateType) -> Disposable) -> Disposable {
        return self.configuration.scheduleRelative(state, dueTime: dueTime, com.careem.adma.booking.framework.action: com.careem.adma.booking.framework.action)
    }
    ...
    */
    public func schedulePeriodic<StateType>(_ state: StateType, startAfter: TimeInterval, period: TimeInterval, com.careem.adma.booking.framework.action: @escaping (StateType) -> StateType) -> Disposable {
        return self.configuration.schedulePeriodic(state, startAfter: startAfter, period: period, com.careem.adma.booking.framework.action: com.careem.adma.booking.framework.action)
    }
}
