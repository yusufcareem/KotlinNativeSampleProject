...
final fileprivate class DelaySink<O: ObserverType>
    ...
    // is scheduled some com.careem.adma.booking.framework.action
    ...
    func on(_ event: Event<E>) {
        ...
        default:
            ...
            if shouldSchedule {
                _cancelable.disposable = _scheduler.scheduleRecursive((), dueTime: _dueTime, com.careem.adma.booking.framework.action: self.drainQueue)
            }
        }
    }
