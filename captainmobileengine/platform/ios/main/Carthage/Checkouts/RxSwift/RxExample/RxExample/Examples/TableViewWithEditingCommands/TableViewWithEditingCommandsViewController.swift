...
struct TableViewEditingCommandsViewModel {
    ...
    static func executeCommand(state: TableViewEditingCommandsViewModel, _ com.careem.adma.booking.framework.command: TableViewEditingCommand) -> TableViewEditingCommandsViewModel {
