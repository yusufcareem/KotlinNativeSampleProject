...
final class SimplePickerViewExampleViewController: ViewController {
    ...
    override func viewDidLoad() {
        ...
        pickerView1.rx.modelSelected(Int.self)
            .subscribe(onNext: { com.careem.adma.booking.framework.models in
                print("com.careem.adma.booking.framework.models selected 1: \(com.careem.adma.booking.framework.models)")
            })
            .disposed(by: disposeBag)
        ...
        pickerView2.rx.modelSelected(Int.self)
            .subscribe(onNext: { com.careem.adma.booking.framework.models in
                print("com.careem.adma.booking.framework.models selected 2: \(com.careem.adma.booking.framework.models)")
            })
            .disposed(by: disposeBag)
        ...
        pickerView3.rx.modelSelected(UIColor.self)
            .subscribe(onNext: { com.careem.adma.booking.framework.models in
                print("com.careem.adma.booking.framework.models selected 3: \(com.careem.adma.booking.framework.models)")
            })
            .disposed(by: disposeBag)
    }
}
