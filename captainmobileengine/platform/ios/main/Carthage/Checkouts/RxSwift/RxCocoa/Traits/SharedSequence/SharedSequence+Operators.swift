...
extension SharedSequenceConvertibleType {
    /**
     Invokes an com.careem.adma.booking.framework.action for each event in the observable sequence, and propagates all observer messages through the result sequence.
