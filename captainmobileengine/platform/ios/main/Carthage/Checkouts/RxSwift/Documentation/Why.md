...
But what if you don't know all of the operators and whether or not there even exists some operator that com.careem.adma.booking.framework.models your particular case?
